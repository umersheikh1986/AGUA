...
const divrig = useRef(null);
  ...
  <div className="flex flex-wrap h-auto justify-center gap-6 w-full">
    ...
    <div className="flex items-center justify-center w-full sm:w-[300px] md:w-[350px] lg:w-[400px]">
      <div className="w-full relative h-[320px] mx-3 bg-white bg-opacity-10 backdrop-blur-lg rounded-xl hover:scale-105 transition-transform duration-300 ease-in-out">
        <div className="flex flex-col items-center relative top-24 px-4">
          ...
          <h2 className="text-white text-lg sm:text-xl text-center mt-4">OPPORTUNITY</h2>
    ...
    <div className="flex items-center justify-center w-full sm:w-[300px] md:w-[350px] lg:w-[400px]">
      <div className="w-full relative h-[320px] mx-3 bg-white bg-opacity-10 backdrop-blur-lg rounded-xl hover:scale-105 transition-transform duration-300 ease-in-out">
        <div className="flex flex-col items-center relative top-24 px-4">
          ...
          <h2 className="text-white text-lg sm:text-xl text-center mt-4">TECHNOLOGY</h2>
          <p className="text-gray-300 text-xs sm:text-sm text-center mt-2">
    ...
    <div className="flex items-center justify-center w-full sm:w-[300px] md:w-[350px] lg:w-[400px]">
      <div className="w-full relative h-[320px] mx-3 bg-white bg-opacity-10 backdrop-blur-lg rounded-xl hover:scale-105 transition-transform duration-300 ease-in-out">
        <div className="flex flex-col items-center relative top-24 px-4">
          ...
          <h2 className="text-white text-lg sm:text-xl text-center mt-4">APPLICATION</h2>
          <p className="text-gray-300 text-xs sm:text-sm text-center mt-2">
    ...
    <div className="flex items-center justify-center w-full sm:w-[300px] md:w-[350px] lg:w-[400px]">
      <div className="w-full relative h-[320px] mx-3 bg-white bg-opacity-10 backdrop-blur-lg rounded-xl hover:scale-105 transition-transform duration-300 ease-in-out">
        <div className="flex flex-col items-center relative top-24 px-4">
          ...
          <h2 className="text-white text-lg sm:text-xl text-center mt-4">STRUCTURE</h2>
          <p className="text-gray-300 text-xs sm:text-sm text-center mt-2">
    ...
    <div className="flex items-center justify-center w-full sm:w-[300px] md:w-[350px] lg:w-[400px]">
      <div className="w-full relative h-[320px] mx-3 bg-white bg-opacity-10 backdrop-blur-lg rounded-xl hover:scale-105 transition-transform duration-300 ease-in-out">
        <div className="flex flex-col items-center relative top-24 px-4">
          ...
          <h2 className="text-white text-lg sm:text-xl text-center mt-4">LEGAL</h2>
          <p className="text-gray-300 text-xs sm:text-sm text-center mt-2">
