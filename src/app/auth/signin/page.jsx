        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20 text-[#AEB7C0]">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium text-[#AEB7C0]">Start for free</span>
              ...
              <form>
                ...
                <div className="mb-5">
                  <button
                      type="submit"
                      onClick={SignUp}
                      className="w-full cursor-pointer btn btn-info rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90">
                      Login
                      </button>
                 </div>

                 <h1 className="text-center text-[#AEB7C0]">OR</h1>
                ...
                <div className="mt-6 text-center text-[#AEB7C0]">
                  <p>
